...
Yele shipwrighting is an influential design lineage: corvettes and corsairs
(atmosphere-landing-capable craft) derive from "the same original Yele design," the
corsair distinguished by an extra comms bulb for hunting alone. "Yele-style frigates"
turn up in Phene service (FH ch. 33) and a Yele contingent (the Larissan Centaur
Division, a heavy frigate division) fights alongside Chaonia under the treaty
(US ch. 24) — so "Yele-style" denotes a recognised hull school used across polities, not
only League-flagged ships.
