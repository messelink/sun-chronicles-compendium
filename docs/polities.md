...
The Yele are coded as a high-prestige scholarly culture — keepers of "the forgotten
...
### The Trinity Coalition — an authoritarian triumvirate holding the Phene↔Yele back door

**Tier:** canon

*— FH ch. 55*

A small but pivotal polity built on the Meli–Kumbala–Tsurru convergence (see
[`systems.md`](systems.md)). Its three systems each face a different power, so the
Coalition controls the only **back door** by which the Phene can move fleets and trade
into the Yele League *without crossing Chaonia* — the strategic prize that drives FH's
Trinity Campaign. It claims ~600 years of unbroken control and a reputation as
unconquerable (reaching any Trinity system requires a slow, costly knnu crossing). Governed
by a triumvirate that "rule[s] by threes" (next entry).

### The Vestal Trinity — rule by threes: the Karsh, the Matrone, and the Magava

**Tier:** canon

*— FH ch. 62*

The triumvirate has three offices, each tied to a solar aspect and a sacred seat on a
different Trinity world: the **Karsh** (eldest; a life appointment — wisdom/institutional
memory; the Grand Sanctuary on Tsurru Prime), the **Matrone** (stability; term-limited;
the Matrone's Hive in Meli), and the **Magava** (youth/vigor; term-limited; the Magava's
Grove on Kumbala Prime). All three rulers were killed when Chaonia took the Coalition;
Sun installed replacements and the Trinity passed to a Chaonian governor (see
[`history.md`](history.md)).

### The Trinity runs on the Ousoos Argosy and an indentured-labour economy

**Tier:** canon

*— FH ch. 55*

The Coalition's operating arm is the **Ousoos Argosy**, the tow-chain operator commanded
by the triumvirate; it sells passage on the three knnu crossings (plus a "services and
insurance tariff") to anyone who pays — including Phene military fleets — while claiming
political neutrality, a framing Chaonia treats as a de-facto Phene alliance (FH ch. 58).
